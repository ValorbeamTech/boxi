  ...
  return (
    <Card data-post-id={uid} className="flex grow flex-col">
      ...
      <div className="flex items-center justify-between p-4 pt-3">
          ...
          <div className="flex -space-x-1">
            <Avatar
              ...
              classNames={{
                ...
                display:
                  "text-tiny-plus dark:ring-dark-700 rounded-xl ring-3 ring-white",
              }}
        ...
        <div className="flex ltr:-mr-1 rtl:-ml-1">
          <Button
            ...
            isIcon
            variant="flat"
            className="hover:text-secondary dark:hover:text-secondary-light size-7 rounded-full"
          >
      ...
      <div>
        <Input
          classNames={{
            root: "dark:border-dark-500 w-full border-t border-gray-200 px-1.5 py-1",
